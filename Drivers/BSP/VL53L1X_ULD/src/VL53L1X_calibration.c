...
VL53L1X_ERROR VL53L1X_CalibrateOffset(VL53L1_Dev_t dev, uint16_t TargetDistInMm, int16_t* offset) {
    uint8_t i, tmp;
...
VL53L1X_ERROR VL53L1X_CalibrateXtalk(VL53L1_Dev_t dev, uint16_t TargetDistInMm, uint16_t* xtalk) {
    uint8_t i, tmp;
