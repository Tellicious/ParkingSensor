...
VL53L1X_ERROR VL53L1X_SetInterMeasurementInMs(VL53L1_Dev_t dev, uint32_t InterMeasMs) {
    uint16_t ClockPLL;
    VL53L1X_ERROR status = 0;
...
VL53L1X_ERROR VL53L1X_GetSignalPerSpad(VL53L1_Dev_t dev, uint16_t* signalPerSp) {
    ...
    *signalPerSp = (uint16_t)(200.0 * signal / SpNb);
    return status;
}
...
VL53L1X_ERROR VL53L1X_GetResult(VL53L1_Dev_t dev, VL53L1X_Result_t* pResult) {
    VL53L1X_ERROR status = 0;
    uint8_t Temp[17];
    uint8_t RgSt = 255;
...
VL53L1X_ERROR VL53L1X_SetDistanceThreshold(VL53L1_Dev_t dev, uint16_t ThreshLow, uint16_t ThreshHigh, uint8_t Window, uint8_t IntOnNoTarget) {
    VL53L1X_ERROR status = 0;
    uint8_t Temp = 0;
...
VL53L1X_ERROR VL53L1X_GetROICenter(VL53L1_Dev_t dev, uint8_t* ROICenter) {
    VL53L1X_ERROR status = 0;
    uint8_t tmp;
